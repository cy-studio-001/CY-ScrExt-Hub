...
`;
          ...
          n &&
            ...
            ((e, t) => {
              ...
              ge.forEach((e) => {
                const o = K(n, r[e]);
                o &&
                  (be(e, t.inputAttributes), (o.className = r[e]), i && Z(o));
              }),
                t.input && (i && fe(t), ye(t));
            })(e, t));
        },
  ...
  function initializeExtension() {
    ...
    class FlexiblePopupExtension {
          ...
          blocks: [
            {
              ...
              text: "显示 [ICON] 弹窗 标题 [TITLE] 内容 [CONTENT] 按钮一 [BTN1] 颜色 [COLOR1] 按钮二 [BTN2] 颜色 [COLOR2] 按钮三 [BTN3] 颜色 [COLOR3]",
              arguments: {
                ICON: {
          ...
          menus: {
            iconMenu: {
              ...
              items: [
                ...
                { text: "成功(success)", value: "success" },
                { text: "警告(warning)", value: "warning" },
                { text: "错误(error)", value: "error" },
                { text: "问题(question)", value: "question" },
              ],
            },
          },
        };
      ...
      showPopup(args) {
        // 动态添加CSS样式确保按钮大小完全一致
        const styleId = "flexible-popup-button-style";
        ...
        const options = {
          ...
          title: args.TITLE,
          text: args.CONTENT,
          confirmButtonText: args.BTN1 || undefined,
          confirmButtonColor: args.COLOR1 || undefined,
          showDenyButton: args.BTN2 !== "",
          denyButtonText: args.BTN2 || undefined,
          denyButtonColor: args.COLOR2 || undefined,
          showCancelButton: args.BTN3 !== "",
          cancelButtonText: args.BTN3 || undefined,
          cancelButtonColor: args.COLOR3 || undefined,
          buttonsStyling: true,
          customClass: {
    ...
    if (typeof Scratch !== "undefined" && Scratch.extensions) {
      Scratch.extensions.register(new FlexiblePopupExtension());
    }
  }
})();
